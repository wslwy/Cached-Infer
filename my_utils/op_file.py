...
if __name__ == "__main__":
    ...
    file = "results/cache_layer_test.pkl"
    ...
    print(loaded_data)
    # for idx, (avg_time, accuracy, sample_num) in enumerate(zip(loaded_data["avg_time_list"], loaded_data["correct_ratio_list"], loaded_data["sample_num_list"])):
    #     print(f"idx: {idx:>2}, avg_time: {avg_time:<7.6}, accuracy: {accuracy:<6.4}, sample_num: {sample_num}")
    #     if data["flag"] == "mule":

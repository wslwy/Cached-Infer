...
if __name__ == "__main__":
    ...
    # ratio = 7
    # num_class_matrix = [
    #     [base*ratio] * 10 + [base] * 10 + [base] * 10 + [base] * 10,
    #     [base] * 10 + [base*ratio] * 10 + [base] * 10 + [base] * 10,
    #     [base] * 10 + [base] * 10 + [base*ratio] * 10 + [base] * 10,
    ...
    print("begin test ...")
    for base, ratio in [(8,1), (5,3), (3,7), (1,27)]:
        print(f"base, ratio: {base, ratio}")
        num_class_matrix = [
            [base*ratio] * 10 + [base] * 10 + [base] * 10 + [base] * 10,
            [base] * 10 + [base*ratio] * 10 + [base] * 10 + [base] * 10,
            [base] * 10 + [base] * 10 + [base*ratio] * 10 + [base] * 10,
